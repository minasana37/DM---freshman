...
![ROC of SVM](svm.png){#fig-svm width="4in" height="4in" fig-align="center"} \## 3.4 Neural networks Neural networks enhance predictive performance by capturing complex nonlinear relationships between features and the target variable.
...
# Acknowledgment
AI tools, including **Deeply** and **ChatGPT**, have been used for proofreading and enhancing the English language proficiency in this report. These tools were employed solely for language improvement purposes, in accordance with the guidelines provided.
